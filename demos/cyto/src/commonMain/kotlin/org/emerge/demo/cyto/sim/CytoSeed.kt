...
object CytoSeed {
    ...
    val STARTER_BIOMASS: Map<String, Int> = mapOf("rg" to 1 * CHEMISTRY_SCALE, "gb" to 1 * CHEMISTRY_SCALE, "br" to 1 * CHEMISTRY_SCALE)
    ...
    /** Autotroph: build biomass (and hold the cytoplasm 'rg' reserve) up to this. */
    ...
    /** Heterotroph: build biomass off stored 'rg' up to this. */

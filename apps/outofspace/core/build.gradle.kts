// :apps:outofspace:core — the shared, platform-free heart of the app: simulation, renderer, UI.
//
...
android {
    namespace = "org.emerge.demo.outofspace"
    compileSdk = 35
    defaultConfig {
        minSdk = 26
    }
...
// registerBuildInfo(packageName = "org.emerge.demo.outofspace.build")

 ...
 * game rules whatsoever. Every line of behaviour lives in `:apps:fluidlab:core`, which is why the
...
fun main() {
    ...
    val window = glfwCreateWindow(1280, 800, "Emerge: Fluidlab", NULL, NULL)

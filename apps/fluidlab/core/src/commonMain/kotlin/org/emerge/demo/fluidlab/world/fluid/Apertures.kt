...
import org.emerge.demo.fluidlab.world.Action
import org.emerge.demo.fluidlab.world.Airlock
import org.emerge.demo.fluidlab.world.Machine
import org.emerge.demo.fluidlab.world.SignalField
 ...
 * for the reasons [org.emerge.demo.fluidlab.chem.Mixture] gives.
 */
/**
 ...
 * reaches in, the room becomes [org.emerge.demo.fluidlab.world.Structure.Vacuum], and the machines

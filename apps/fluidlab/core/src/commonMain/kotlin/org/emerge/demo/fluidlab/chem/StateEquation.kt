 ...
 * [org.emerge.demo.fluidlab.world.fluid.tilePressure]. An ideal gas has no liquid phase and
...
class Critical(val kelvin: Int, val gramsPerTile: Long, private val species: Species) {
    ...
    /**
     * Critical pressure, in the units [org.emerge.demo.fluidlab.world.fluid.tilePressure]
 ...
 * `org.emerge.demo.fluidlab.world.Temperature.AMBIENT_KELVIN`. Restated rather than imported so
 ...
 * declared.
 *
 * [org.emerge.demo.fluidlab.world.AirField.AMBIENT_AIR] puts one kilogram of air in a full tile
 ...
 * [org.emerge.demo.fluidlab.world.fluid.millimolesOf] already sums moles, and a water cell

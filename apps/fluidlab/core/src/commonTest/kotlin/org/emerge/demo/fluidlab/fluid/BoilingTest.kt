...
import org.emerge.demo.fluidlab.chem.FluidPhase
import org.emerge.demo.fluidlab.chem.Species
import org.emerge.demo.fluidlab.chem.phaseAt
import org.emerge.demo.fluidlab.chem.reducedDensity
import org.emerge.demo.fluidlab.chem.reducedTemperature
import org.emerge.demo.fluidlab.chem.SCALE
import org.emerge.demo.fluidlab.chem.liquidFraction
...
import org.emerge.demo.fluidlab.world.fluid.gasCapacity
import org.emerge.demo.fluidlab.world.fluid.gasKelvin
import org.emerge.demo.fluidlab.world.fluid.ambientGasJoules
...
class BoilingTest {
    ...
    private val poolGrams =
        saturatedLiquidDensity(reducedTemperature(COLD, Species.Water)!!)!! *
            CRITICAL.getValue(Species.Water).gramsPerTile / org.emerge.demo.fluidlab.chem.SCALE

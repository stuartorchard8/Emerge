// :apps:fluidlab:core — the shared, platform-free heart of the app: simulation, renderer, UI.
//
...
android {
    namespace = "org.emerge.demo.fluidlab"
    compileSdk = 35
    defaultConfig {
        minSdk = 26
    }
...
// registerShaderCodegen(packageName = "org.emerge.demo.fluidlab.shader")
...
// registerBuildInfo(packageName = "org.emerge.demo.fluidlab.build")

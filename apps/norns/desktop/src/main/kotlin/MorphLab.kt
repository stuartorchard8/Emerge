...
class MorphLab {
    ...
    private fun selectNode(n: MorphNode) {
        ...
        nodeEditor.add(extraSlider(n, "vdz", "→ move z", -1.0, 1.0, 0f))
        ...
        nodeEditor.add(extraSlider(n, "vsz", "→ deepen", -1.0, 1.0, 0f))
        ...
        nodeEditor.add(extraSlider(n, "adz", "→ move z", -1.0, 1.0, 0f))
        ...
        nodeEditor.add(extraSlider(n, "asz", "→ deepen", -1.0, 1.0, 0f))
        ...
        nodeEditor.add(extraSlider(n, "ddz", "→ move z", -1.0, 1.0, 0f))
        ...
        nodeEditor.add(extraSlider(n, "dsz", "→ deepen", -1.0, 1.0, 0f))

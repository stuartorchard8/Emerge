 ...
 */
class TemplateRenderer(private val cfg: TemplateConfig = TemplateConfig()) {
    ...
    fun draw(state: TemplateState) {
        ...
        for (b in state.bodies) {
            ...
            // Cull what is off-screen. At template scale this is free; at Cyto scale it is the

 ...
 */
internal class TemplateAndroidView(context: Context) : GLSurfaceView(context) {

    private val controller = TemplateController()
    ...
    private var hud: TemplateHud? = null
    ...
    private fun setup() {
        renderer = TemplateRenderer(controller.cfg)
        hud = TemplateHud().also {
